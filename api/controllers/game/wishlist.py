...
from operations.games import wishlist as libraryCrud
...
@router.get("/{game_id}", response_model=librarySchema.Wishlist)
...
@router.get("/", response_model=List[librarySchema.Wishlist])
def get_all_games(db: Session = Depends(get_db)):
    return libraryCrud.get_games(db)


@router.put("/{game_id}", response_model=librarySchema.Wishlist)
